<?php
/**
 * Template Name: Quiero suscribirme [NO DATOS]
 */
					...
					<?php endwhile; // end of the loop. ?>
					         	  ...
					         	  if ($show_form) :
					         	  	...
					         	  	if ($_REQUEST['error'] == 1) : ?>
												...
												<?php endif; ?>
												<?php if ($user_new) : ?>
											    <form id="subscribe-form" method="post" class="<?php if ($user_new ) : echo "alta-suscripcion"; endif; ?>" action="<?php echo get_stylesheet_directory_uri(); ?>/user-subscribe-no-card.php"> 
												<?php else : ?>
							           	  ...
							           	  <div class="form-group"> <!-- password -->
							           	    <label for="password" <?php if ( !$user_new ) : echo "hidden"; endif; ?>>Contraseña</label>
					  	           	  ...
					  	           	  <div class="form-group">
							           	  ...
							           	  <div class="row"> <!-- direccion y localidad -->
						    	           	  ...
						    	           	  <div class="form-group">
						    	           	    ...
						    	           	    <input type="text" name="direccion" class="form-control" id="direccion" value="" placeholder="Nombre de la calle y nro. de la casa">
									           	    <div class="messages"></div>
						    	           	  </div>
						  	           	  </div>
							           	  	<div class="col-md-6">
							           	  ...
							           	  <button type="submit" class="btn btn-outline-plot btn-suscribite" id="">Suscribirme</button>
							           	  </div>
											    </form>
													<script>
